...
router.post(
  ...
  async (req: Request, res: Response) => {
    ...
    await FollowCollection.addOne(user);
    await ReputationCollection.addOne(user);
    req.session.userId = user._id.toString();
    res.status(201).json({
...
router.delete(
  ...
  async (req: Request, res: Response) => {
    ...
    await FollowCollection.removeOne(req.session.userId);
    await ReputationCollection.removeOne(req.session.userId);
